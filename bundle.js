...
require("@nicoleoliveira/button");

},{"@nicoleoliveira/button":2}],2:[function(require,module,exports){
"use strict";
...
var _indexEsm = require("../common/index.esm.js");
...
var Button = /*#__PURE__*/function (_HTMLElement) {
  ...
  _createClass(Button, [{
    ...
    get: function get() {
      ...
      return (0, _indexEsm.transformBooleanProperties)(disabled);
    }
  }, {
    key: "danger",
    get: function get() {
      ...
      return (0, _indexEsm.transformBooleanProperties)(isDanger);
    }
  }, {
    key: "size",
    get: function get() {
...
},{"../common/index.esm.js":3}],3:[function(require,module,exports){
"use strict";
